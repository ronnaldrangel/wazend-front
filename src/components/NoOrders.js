...
const NoOrders = () => {
  ...
  return (
    <div className="bg-white rounded-xl px-6 py-20 text-center">
      ...
      <h3 className="mt-2 text-xl font-semibold text-gray-900">Mejores charlas = más ventas 💸</h3>
      <p className="mt-1 text-md text-gray-500">Es necesario elegir un plan para continuar</p>
      <div className="mt-6">
        <button
          type="button"
