            ...
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="w-full md:w-4/5">
                    ...
                    <button
                        ...
                        className="mb-6 inline-flex items-center px-4 py-2 bg-card text-foreground border border-border hover:bg-muted rounded-md text-sm font-medium shadow-sm hover:shadow transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-border focus:ring-opacity-50"
                    >
